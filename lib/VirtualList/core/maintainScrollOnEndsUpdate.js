import { getStringifiedItemIds, placeSeparatorAtEnds, getIdsFromStringifiedIds, } from './stringifiedItemIdsHelpers';
...
export const maintainScrollOnEndsUpdate = (params) => {
    const { newItems, actualScroll, scrollHeight, oldVisibleItems, oldStringifiedIds, endsUpdateOptions: { addedAtTop = false, removedFromTop = false, addedAtBottom = false, removedFromBottom = false, }, } = params;
    // input check
    ...
    if (oldsItemAfterCommonItemId !== newItemsAfterCommonItemId) {
        ...
        itemsHaveBeen.removedFromBottom = oldsItemAfterCommonItemId.startsWith(newItemsAfterCommonItemId);
    }
    const success = (addedAtTop && itemsHaveBeen.addedAtTop) ||
...
//# sourceMappingURL=maintainScrollOnEndsUpdate.js.map