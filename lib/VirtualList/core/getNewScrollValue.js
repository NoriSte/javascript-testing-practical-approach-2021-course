...
export const getNewScrollValue = (params) => {
    ...
    if (updateScrollModeOnDataChange === 'none' ||
    ...
    const itemToMaintainVisibleUpdated = params.newItems.find(({ item }) => item.id === itemToMaintainVisible.item.id);
...
//# sourceMappingURL=getNewScrollValue.js.map